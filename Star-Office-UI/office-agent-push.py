...
# === 你需要填入的信息 ===
JOIN_KEY = os.environ.get("OFFICE_JOIN_KEY", "")   # 必填：你的一次性 join key（或环境变量 OFFICE_JOIN_KEY）
AGENT_NAME = os.environ.get("OFFICE_AGENT_NAME", "")  # 必填：你在办公室里的名字（或环境变量 OFFICE_AGENT_NAME）
OFFICE_URL = os.environ.get("OFFICE_URL", "https://office.hyacinth.im")  # 办公室地址（本地联调可设 OFFICE_URL=http://127.0.0.1:19000）
